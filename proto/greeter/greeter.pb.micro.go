...
func (c *greeterService) Set(ctx context.Context, in *SetRequest, opts ...client.CallOption) (*ComRsp, error) {
	req := c.c.NewRequest(c.name, "Greeter.Set", in)
	out := new(ComRsp)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func RegisterGreeterHandler(s server.Server, hdlr GreeterHandler, opts ...server.HandlerOption) error {
	type greeter interface {
		...
		Set(ctx context.Context, in *SetRequest, out *ComRsp) error
	}
	type Greeter struct {
		greeter
	}
...
func (h *greeterHandler) Set(ctx context.Context, in *SetRequest, out *ComRsp) error {
	return h.GreeterHandler.Set(ctx, in, out)
}
